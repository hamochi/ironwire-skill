...
name: ironwire
description: >-
  Drive the ironwire VM fleet with the `ironwire` CLI — sign up for an account, create
  ...
  schedule (e.g. "every morning read my email and tell me"). Works identically on a
  laptop and inside a machine.
---
